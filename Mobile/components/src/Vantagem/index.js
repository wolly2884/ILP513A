...
function Vantagem(valor){
  ...
  if(valor == 0 ){
    ...
    return 'O Gasolina é Mais Vantajoso'
  }else {
    return 'O Alcool é Mais Vantajoso'
  }
...
useEffect( () => {
  ...
  <View>
    ...
    <View>
      <Inputtxt titulo="Preço do Alcool"  funcao={setText1}  />
      <Inputtxt titulo="Preço da Gasolina"   funcao={setText2}  />
